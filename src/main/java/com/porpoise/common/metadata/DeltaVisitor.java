...
public class DeltaVisitor<D> extends VisitorAdapter {
	 ...
	 */
	@Override
	public <T, P, I extends Iterable<T>> VisitorResult onIterables(final Metadata<P, I> property, final I thingOne,
	        final I thingTwo) {
		return result();
	}
	...
	private <T, P, I extends Iterable<T>> Delta<T> processIterableItem(final Metadata<P, I> property, final int index,
	        final Pair<I, T> pairOne, final Pair<I, T> pairTwo) {
		final T thingOne = pairOne.getSecond();
		final T thingTwo = pairTwo.getSecond();
		if (!Objects.equal(thingOne, thingTwo)) {
	 ...
	 */
	@Override
	public <K, V, P> VisitorResult onMapEntry(final Metadata<P, Map<K, V>> property, final K key,
	 ...
	 * @return
	 */
	private <V, K, P> VisitorResult processMapEntry(final Metadata<P, Map<K, V>> property, final K key,
	        final Pair<Map<K, V>, V> pairOne, final Pair<Map<K, V>, V> pairTwo) {
	 ...
	 */
	@Override
	public <T, P, I extends Iterable<T>> VisitorResult beforeIterablesWithMetadata(final Metadata<P, I> property,
	        final I thingOne, final I thingTwo) {
		return result();
	}
	 ...
	 */
	@Override
	public <T, P, I extends Iterable<T>> VisitorResult afterIterablesWithMetadata(final Metadata<P, I> property,
	        final I thingOne, final I thingTwo) {
		return result();
	}
	 ...
	 */
	@Override
	public <T, P, I extends Iterable<T>> VisitorResult beforeIterableItemWithMetadata(final Metadata<P, I> property,
	 ...
	 */
	@Override
	public <T, P, I extends Iterable<T>> VisitorResult afterIterableItemWithMetadata(final Metadata<P, I> property,
	        final int index, final Pair<I, T> pairOne, final Pair<I, T> pairTwo) {
		this.workingDelta.pop();
		return result();
	}
	 ...
	 */
	@Override
	public <K, V, P> VisitorResult beforeMapsWithMetadata(final Metadata<P, Map<K, V>> property,
	 ...
	 */
	@Override
	public <K, V, P> VisitorResult afterMapsWithMetadata(final Metadata<P, Map<K, V>> property,
	        final Pair<P, Map<K, V>> thingOne, final Pair<P, Map<K, V>> thingTwo) {
		return result();
	}
	 ...
	 */
	@Override
	public <K, V, P> VisitorResult beforeMapEntryWithMetadata(final Metadata<P, Map<K, V>> property, final K key,
	        final Pair<Map<K, V>, V> pairOne, final Pair<Map<K, V>, V> pairTwo) {
	 ...
	 */
	@Override
	public <K, V, P> VisitorResult afterMapEntryWithMetadata(final Metadata<P, Map<K, V>> property, final K key,
	        final Pair<Map<K, V>, V> pairOne, final Pair<Map<K, V>, V> pairTwo) {
		this.workingDelta.pop();
		return result();
	}
