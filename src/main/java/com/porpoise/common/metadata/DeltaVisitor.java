...
public class DeltaVisitor<D> extends VisitorAdapter {
     ...
     */
    @Override
    public <K, V, P> VisitorResult onMapEntry(final Metadata<P, Map<K, V>> property, final K key, final Pair<Map<K, V>, V> pairOne, final Pair<Map<K, V>, V> pairTwo) {
     ...
     * @return
     */
    private <V, K, P> VisitorResult processMapEntry(final Metadata<P, Map<K, V>> property, final K key, final Pair<Map<K, V>, V> pairOne, final Pair<Map<K, V>, V> pairTwo) {
